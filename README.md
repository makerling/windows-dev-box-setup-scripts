...
|---------|---------|
|<a href='http://boxstarter.org/package/url?https://raw.githubusercontent.com/Microsoft/makerling/windows-dev-box-setup-scripts/master/dev_app.ps1'>FLEx 9 Dev Environment</a>     | Windows FLEx 9 Development (Visual Studio, Windows SDK, C++, UWP, .NET (WPF and Winforms)) |
